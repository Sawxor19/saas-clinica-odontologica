...
Sistema multi-clínica de gestão odontológica com Supabase, Stripe e Next.js (App Router).
...
1) Crie os produtos e preços para os planos:
...
- REMINDERS_SECRET é obrigatório para /api/reminders (use header x-reminders-secret).
